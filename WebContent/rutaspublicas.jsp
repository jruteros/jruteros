	...
	<div class="row">
		...
		<div class="col-md-4">
			...
			<form action="#buscar">
				...
				<div>Seleccione un punto en el mapa para buscar por cercanía a ese sitio</div>
				<div id="map">
				</div>
				
				<div>Distancia maxíma al punto: 
	 				<input id="radio" type="text" name="radio" />
				</div>
   <script>
		...
		<table class="table">
			<thead>
		        <tr>
		            ...
		            <th data-column-id="cantidad" data-type="string">Veces realizadas</th>
