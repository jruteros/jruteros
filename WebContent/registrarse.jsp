...
<div id="login">
		...
		<h2><span class="fontawesome-lock"></span>Registrarse</h2>
		  
		<form  id="formu" method="post" action="registroExitoso.jsp">
			<fieldset>

				<label for="nombreUsuario">Nombre de usuario:</label>			
				<p><input type="text"  id="nombreUsuario" name="nombreUsuario"  /></p>  
				...
				<p><input type="text" id="apellido" name="apellido" /></p>

				<label for="dni">DNI:</label>
				<p><input type="text" id="dni" name="dni" /></p>
				
				<label for="domicilio">Domicilio:</label>
				<p><input type="text" id="domicilio" name="domicilio" /></p>
