...
<div id="content">
		...
		<form id="login">
			<h2><span class="fontawesome-lock"></span>Nueva Ruta</h2>
			<fieldset>

				<p><label for="nombreRuta">Nombre de la ruta:</label></p>			
				<p><input type="text"  name="nombreRuta"  /></p> 
				...
				<input id="privacidad_publica" type="radio" name="privacidad" value="publica" />
            ...
            mymap.on('click', onMapClick);
				...
				<input id="formato_ida" type="radio" name="formato" value="ida" />
				...
				<p><input type="text"  name="distancia"  /></p>

				<p><label for="tiempo">Tiempo estimado:</label></p>			
				<p><input type="text"  name="tiempo"  /></p>
				
				<p><label for="fecha">Fecha realización:</label></p>			
				<p><input type="date"  name="fecha"  placeholder="dd/mm/AAAA"/></p>
